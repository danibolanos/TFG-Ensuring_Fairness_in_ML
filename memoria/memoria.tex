...
\begin{itemize}
    ...
    \item 16 GB RAM DDR4.
    \item 1 socket, 8 núcleos por socket, 2 hilos de procesamiento por núcleo.
    \item Sistema Operativo Linux \textcolor{red}{mirar}.
\end{itemize}

Se ha utilizado la versión de Python \textcolor{red}{mirar}, así como los siguientes paquetes: numpy, pandas, scikit-learn, pickle $\dots$

Además se ha utilizado el paquete \cite{pystan} que funciona como una interfaz de Python para el lenguaje de programación probabilística \cite{stan}. El cual permite generar muestras de datos a partir de métodos que trabajan con cadenas de Markov (como MCMC) y crear modelos causales sobre los que operar gracias a la inferencia estadística Bayesiana.
